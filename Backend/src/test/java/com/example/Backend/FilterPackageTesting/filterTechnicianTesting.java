package com.example.Backend.FilterPackageTesting;
...
import com.example.Backend.services.filterTechnicianService;
...
public class filterTechnicianTesting {
    ...
    void filterByRate()
    {
        ...
        Assertions.assertEquals(DTOs.get(0).getFName(),"Mahmoud");
    }
    ...
    @Test
    void filterByGovernate()
    {
        List<TechnicianDTO>DTOs=filterTechnicianService.filterTechnician("governorate","AlBehira");
    ...
    @Test
    void shouldNotReturnAnyOne()
    {
        List<TechnicianDTO>DTOs=filterTechnicianService.filterTechnician("District","elRaml2");
