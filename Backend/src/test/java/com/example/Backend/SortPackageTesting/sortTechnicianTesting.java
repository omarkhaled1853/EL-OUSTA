package com.example.Backend.SortPackageTesting;
...
import com.example.Backend.services.sortTechnicianService;
...
public class sortTechnicianTesting {
    ...
    public void setup()
    {
        ...
        tech2.setStartDate(new Date(2001, 5, 10));
        tech2.setRate("2");
        ...
        tech4.setStartDate(new Date(2010, 3, 20));
        tech4.setRate("4");
        ...
        tech5.setStartDate(new Date(2005, 7, 5));
        tech5.setRate("3");
    ...
    {
        List<TechnicianDTO>DTOs=sortService.sortTechnicians("experience");
        Assertions.assertEquals(DTOs.size(),5);
        Assertions.assertEquals(DTOs.get(1).getFName(),"mohammed");
    }
    @Test
    void sortByRate()
    {
        ...
        Assertions.assertEquals(DTOs.size(),5);
        Assertions.assertEquals(DTOs.get(0).getFName(),"Nada");
    }
    @Test
    void NullSort()
    {
        List<TechnicianDTO>DTOs=sortService.sortTechnicians("password");
        Assertions.assertEquals(DTOs.size(),5);
        Assertions.assertEquals(DTOs.get(0).getFName(),"youssef"); //they came in same order
    }
